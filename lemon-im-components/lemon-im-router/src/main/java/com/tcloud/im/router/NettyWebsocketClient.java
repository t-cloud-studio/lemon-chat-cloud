    ...
    public ChannelFuture connect(OnOpenHandler onOpenHandler, OnMessageHandler onMessageHandler,
        ...
        synchronized (this) {
            ...
            try {
                ...
                log.warn("连接server异常 host:{} port:{}", host, port, e);
            }
            return null;
        }
    }
    ...
    private static class WebSocketClientHandler extends SimpleChannelInboundHandler<Object> {
        ...
        protected void channelRead0(ChannelHandlerContext channelHandlerContext, Object msg) throws Exception {
            if (!handshake.isHandshakeComplete()) {
                handshake.finishHandshake(channelHandlerContext.channel(), (FullHttpResponse) msg);
            ...
            if (frame instanceof TextWebSocketFrame textFrame) {
                ...
                log.debug("接收到server传来的close帧 remoteAddress:{}", channelHandlerContext.channel().remoteAddress());
        ...
        public void channelInactive(ChannelHandlerContext ctx) throws Exception {
            log.info("连接关闭 remoteAddress:{}", ctx.channel().remoteAddress());
