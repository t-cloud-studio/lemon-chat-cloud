package com.tcloud.web.auth.utils;
...
public class IPUtil {
    ...
    public HttpServletRequest getRequest() {
        RequestAttributes requestAttributes = Optional.ofNullable(RequestContextHolder.getRequestAttributes()).orElseThrow(() -> new NullPointerException("request is null"));
